...
public class Processor {
    ...
    public ProcessResponse process(ProcessRequest request) {
        ...
        try {
            ...
            //todo xuelian
            System.err
                .println(" before set com.alipay.sofa.registry.jraft.processor.Processor.process");
            ...
            //todo xuelian
            System.err
                .println(" after set com.alipay.sofa.registry.jraft.processor.Processor.process");
            if (ret != null) {
